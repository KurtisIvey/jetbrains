...
//        System.out.println("Congrats! The secret code is 9305.");
    ...
    public static void process (String guess, String secretCode) {
        ...
        if(similarCharsAtIndex > 0 && cows == 0) {
            System.out.printf("Grade: %s", stringOutput(similarCharsAtIndex, "bulls"));
        } else if( similarCharsAtIndex == 0 && cows > 0) {
            System.out.printf("Grade: %s", stringOutput(similarCharsAtIndex, "cows"));

        } else if( similarCharsAtIndex > 0 && cows > 0) {
            System.out.printf("Grade: %s and %s", stringOutput(similarCharsAtIndex, "bulls"),stringOutput(cows, "cows") );
        } else {
            System.out.printf("Grade: %s and %s", stringOutput(0, "bulls"),stringOutput(0, "cows") );
        }
